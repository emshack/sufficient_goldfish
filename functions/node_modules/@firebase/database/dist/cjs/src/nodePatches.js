 ...
 */
BrowserPollConnection_1.FirebaseIFrameScriptHolder.nodeRestRequest = function (req, onComplete) {
    if (!BrowserPollConnection_1.FirebaseIFrameScriptHolder.request)
        BrowserPollConnection_1.FirebaseIFrameScriptHolder.request = /** @type {function({url: string, forever: boolean}, function(Error, number, string))} */ require('request');
    BrowserPollConnection_1.FirebaseIFrameScriptHolder.request(req, function (error, response, body) {
        if (error)
 ...
 */
BrowserPollConnection_1.FirebaseIFrameScriptHolder.prototype.doNodeLongPoll = function (url, loadCB) {
    var self = this;
    BrowserPollConnection_1.FirebaseIFrameScriptHolder.nodeRestRequest({ url: url, forever: true }, function (body) {
        self.evalBody(body);
        loadCB();
    });
};
 ...
 * @param {!string} body
 */
BrowserPollConnection_1.FirebaseIFrameScriptHolder.prototype.evalBody = function (body) {
    var jsonpCB;
